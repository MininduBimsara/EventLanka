          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 transition-opacity duration-300 opacity-0 bg-gradient-to-t from-[#B07C9E] to-transparent group-hover:opacity-100">
                  <div className="flex justify-center space-x-4">
                    <a href="#" className="text-white hover:text-[#D2A1B8]">
                      <svg
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-[#6622CC]">{member.role}</p>
              </div>
            </div>
          ))}
        </div>
