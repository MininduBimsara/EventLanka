        ...
        <div className="max-w-md">
          ...
          <div className="mb-6">
            <div className="relative inline-block">
              ...
              <div className="relative flex items-center justify-center w-48 h-20 p-8 bg-pink-400 rounded-lg">
                {/* Golden swoosh decoration */}
                <div className="absolute w-32 h-12 transform border-t border-yellow-300 rounded-full rotate-12"></div>
              </div>
            </div>
          </div>

          {/* Brand Name */}
          <h1 className="mb-2 text-4xl font-bold text-blue-900 md:text-5xl lg:text-6xl">
            EVENTLANKA
          </h1>

          {/* Tagline */}
          <p className="text-lg text-blue-900 md:text-xl">
          ...
          <div className="mt-12 md:hidden">
            ...
            <p className="mb-4 text-gray-700">123-456-7890</p>
