...
export default function OrganizerProfile() {
  const [profile, setProfile] = useState({
    ...
    bio: "Event organizer with 8+ years of experience specializing in corporate conferences and music festivals. Based in Austin, Texas.",
    website: "https://janesmith-events.com",
    social: {
      instagram: "jane_events",
      facebook: "janesmith.events",
      linkedin: "janesmith-events",
    },
    categories: ["Corporate", "Music", "Conferences"],
    isPublic: true,
  });
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="col-span-1">
          <div className="flex flex-col items-center">
            <div className="relative w-48 h-48 mb-4">
              ...
              <button className="absolute p-2 text-white bg-blue-600 rounded-full bottom-2 right-2 hover:bg-blue-700">
                <Camera size={20} />
              </button>
            </div>
        ...
        <div className="col-span-1 lg:col-span-2">
          <div className="p-6 rounded-lg bg-gray-50">
            ...
            {isEditing && (
              <div className="mt-6">
                <button className="flex items-center px-6 py-2 text-white bg-green-600 rounded-md hover:bg-green-700">
